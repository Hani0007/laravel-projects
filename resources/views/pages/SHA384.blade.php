...
<!-- Bootstrap CSS -->
  ...
  <script>
    ...
    function encryptText() {
      ...
      var encryptedText = CryptoJS.SHA384(inputText); // Encrypt the input text using SHA384
...
<body>
  ...
  <main id="main" class="main text-white">
    ...
    <div class="pagetitle">
      <h1 class="text-white">SHA384 Encryption</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item text-white"><a href="">Home</a></li>
          <li class="breadcrumb-item active text-white">SHA384 Encrypt/Decrypt</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
